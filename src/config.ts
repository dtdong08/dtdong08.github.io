...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/dtdong08/dtdong08.github.io", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://www.facebook.com/dtdong08/",
		},
		{
			name: "Instagram",
			icon: "fa6-brands:instagram",
			url: "https://www.instagram.com/_dt.dong/",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/dtdong08/",
		},
	],
};
